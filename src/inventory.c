...
const InventoryTab inventory[NUM_INVENTORY_TABS] = {
    ...
    },
    {
        "Plants", 5,
        {
            B(BLOCK_FLOWER), {BLOCK_FLOWER, BLOCK_DATA_TEXTURE1}, B(BLOCK_TALL_GRASS), B(BLOCK_WHEAT), B(BLOCK_SUGAR_CANE)
        }
    },
    {
        "Redstone", 5,
        {
            B(BLOCK_REDSTONE_LAMP), B(BLOCK_REDSTONE_WIRE), {BLOCK_REDSTONE_TORCH, BLOCK_DATA_POWER | BLOCK_DATA_TEXTURE1}, B(BLOCK_LEVER), B(BLOCK_TNT)
        }
    }
};
