...
const InventoryTab inventory[NUM_INVENTORY_TABS] = {
    {
        ...
        {
            B(BLOCK_STONE), B(BLOCK_COBBLESTONE), B(BLOCK_SAND), B(BLOCK_DIRT), B(BLOCK_GRASS), B(BLOCK_PLANKS),
            B(BLOCK_GLASS), B(BLOCK_COAL_ORE), B(BLOCK_IRON_ORE), B(BLOCK_GOLD_ORE), B(BLOCK_REDSTONE_ORE), B(BLOCK_DIAMOND_ORE),
            B(BLOCK_WATER), B(BLOCK_LAVA), B(BLOCK_BOOKSHELF), B(BLOCK_DOOR), B(BLOCK_CRAFTING_TABLE), B(BLOCK_FURNACE),
            B(BLOCK_BRICKS), B(BLOCK_WOOD_SLAB), B(BLOCK_COBBLESTONE_SLAB), B(BLOCK_BASALT)
        }
    },
    {
        "Plants", 12, B(BLOCK_FLOWER),
        {
            B(BLOCK_WOOD), {BLOCK_WOOD, BLOCK_DATA_TEXTURE1}, B(BLOCK_LEAVES), {BLOCK_LEAVES, BLOCK_DATA_TEXTURE1}, B(BLOCK_CACTUS), B(BLOCK_TALL_GRASS),
            B(BLOCK_FLOWER), {BLOCK_FLOWER, BLOCK_DATA_TEXTURE1}, {BLOCK_FLOWER, BLOCK_DATA_TEXTURE2}, {BLOCK_FLOWER, BLOCK_DATA_TEXTURE3}, B(BLOCK_WHEAT), B(BLOCK_DEAD_SHRUB),
            B(BLOCK_SUGAR_CANE), B(BLOCK_MUSHROOM), {BLOCK_MUSHROOM, BLOCK_DATA_TEXTURE1}, B(BLOCK_MOSS)
        }
    },
    {
        "Redstone", 10, B(BLOCK_REDSTONE_TORCH),
        {
            B(BLOCK_REDSTONE_LAMP), B(BLOCK_REDSTONE_WIRE), {BLOCK_REDSTONE_TORCH, BLOCK_DATA_POWER | BLOCK_DATA_TEXTURE1}, B(BLOCK_REDSTONE_REPEATER), B(BLOCK_LEVER), B(BLOCK_PRESSURE_PLATE),
            B(BLOCK_TNT), B(BLOCK_PISTON), B(BLOCK_COMPUTER), B(BLOCK_NOTEBLOCK)
        }
    }
};
